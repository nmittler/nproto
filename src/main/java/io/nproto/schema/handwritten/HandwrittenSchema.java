...
final class HandwrittenSchema implements Schema<PojoMessage> {
  ...
  public void mergeFrom(PojoMessage message, Reader reader) {
    while (true) {
      ...
      switch(fieldNumber) {
        case 1:
          message.enumField = MyEnum.class.cast(reader.readEnum());
          break;
        case 2:
        ...
        case 16:
          if (message.enumListField == null) {
            message.enumListField = new ArrayList<MyEnum>();
          }
          message.enumListField.add(MyEnum.class.cast(reader.readEnum()));
          break;
        case 17:
