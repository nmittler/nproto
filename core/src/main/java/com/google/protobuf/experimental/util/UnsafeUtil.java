...
public final class UnsafeUtil {
  ...
  private static final Strategy STRATEGY = JdkUnsafeStrategy.IS_SUPPORTED ?
          new JdkUnsafeStrategy() : new AndroidUnsafeStrategy();
  private static final long BYTE_ARRAY_BASE_OFFSET = STRATEGY.isSupported() ?
          STRATEGY.arrayBaseOffset(byte[].class) : -1;
  ...
  private static final class JdkUnsafeStrategy extends Strategy {
    ...
    static {
      ...
      BUFFER_ADDRESS_OFFSET = supported ? UNSAFE.objectFieldOffset(field(Buffer.class, "address")) : -1;
    }
