...
import com.google.protobuf.experimental.util.InternalUtil;
...
public abstract class ByteString implements Iterable<Byte>, Serializable {
   ...
   */
  public static final ByteString EMPTY = new LiteralByteString(InternalUtil.EMPTY_BYTE_ARRAY);
  ...
  public static ByteString copyFromUtf8(String text) {
    return new LiteralByteString(text.getBytes(InternalUtil.UTF_8));
  }
  ...
  public final byte[] toByteArray() {
    final int size = size();
    if (size == 0) {
      return InternalUtil.EMPTY_BYTE_ARRAY;
    }
  ...
  public final String toStringUtf8() {
    return toString(InternalUtil.UTF_8);
  }
  ...
  private static class LiteralByteString extends ByteString.LeafByteString {
    ...
    protected final int partialHash(int h, int offset, int length) {
      return InternalUtil.partialHash(h, bytes, getOffsetIntoBytes() + offset, length);
    }
